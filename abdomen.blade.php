...
<body>
	...
	<div class="container-fluid">
		...
		<li class="breadcrumbs__item">
            <li class="breadcrumbs__link breadcrumbs__link--active">ABDOMEN</li>
        </li>
		</ol>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
                        ...
                        <br>
                        <br>
                        <h5>CRUNCH CON PIERNAS ELVADAS </h5>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
