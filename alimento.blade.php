...
<body>
  <div id="preloder">
	...
	<div><header class="header-section">
		<a href="https://gymvirtualhuejutla.000webhostapp.com/" class="site-logo">
			<img src="imgs/logo.png" alt="">
		</a>
		<ul class="main-menu">
			<li><a href="/">INICIO</a></li>
			<li><a href="classes">EJERCICIO</a></li>
			<li><a class="active" href="compras">COMPRAS</a></li>
      ...
      <div class="col-md-7 container-search">
        ...
        <center>
          <div class="input-group mb-12">
            ...
            <button class="" style="background-color:black;" id="Filtros">
        ...
        <form action="" id="form-filtros">
          <div class="container">
            <div class="row">
              ...
              <div class="col-2">
                <h7><small>Proteinas</small></h7>
                <br>
                <input type="checkbox" onclick="uncheck()" class="form-check-input" id="P" name="1" value="1" />
              </div>
              <div class="col-2">
                <h7><small>Cereal</small></h7>
                <br>
                <input type="checkbox" onclick="uncheck()" class="form-check-input" id="C" name="2" value="2" />
              </div>
              <div class="col-2">
                <h7><small>Galletas</small></h7>
                <br>
                <input type="checkbox" onclick="uncheck()" class="form-check-input" id="G" name="3" value="3" />
              </div>
              <div class="col-2">
                <h7><small>Jugo</small></h7>
                <br>
                <input type="checkbox" onclick="uncheck()" class="form-check-input" id="J" name="4" value="4" />
              </div>
              <div class="col-2">
  ...
  <script>
    function uncheck() {
      var checkbox1 = document.getElementById("P");
      var checkbox2 = document.getElementById("C");
      var checkbox3 = document.getElementById("G");
      var checkbox4 = document.getElementById("J");
    ...
    function buscar_datos(consulta) {
      $.ajax({
          url: "/GYM/Gym/Buscar_alimentos.php",
          type: "POST",
          dataType: "html",
          data: {
            consulta: consulta,
