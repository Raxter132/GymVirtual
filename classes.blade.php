			...
			<div class="row">
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
						...
						<a href="brazo"><div class="ib-icon">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
						...
						<a href="pecho"><div class="ib-icon">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
						...
						<a href="hombro"><div class="ib-icon">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
						...
						<a href="abdomen"><div class="ib-icon">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
						...
						<a href="pierna"><div class="ib-icon">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
						...
						<a href="espalda"><div class="ib-icon">
