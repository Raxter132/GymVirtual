...
<body>
    ...
    <center><table>
        ...
        <tr>
        <td>
        <a title="ALIMENTOS" href="https://gymvirtualuthhh.proyectoarp.com/alimento.php"><img style="border-radius:12%;" src="imgs/ALIMENTOS.png" alt="alimentos" width="400" height="400" HSPACE="30" VSPACE="30"/></center>
        <br>
        <br>
        </td>
        <td>
       <a title="HERRAMIENTAS" href="https://gymvirtualuthhh.proyectoarp.com/herramientas.php"><img style="border-radius:12%;" src="imgs/HERRAMIENTAS.png" alt="HERRAMIENTAS" width="400" height="400" HSPACE="30" VSPACE="30"/></center>
        <br>
        <br>
        </td>
        </tr>
