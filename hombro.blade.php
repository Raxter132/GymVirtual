...
<body>
	...
	<header class="header-section">
		...
		<ul class="main-menu">
			...
			<li><a class="active" href="classes">EJERCICIO</a></li>
	...
	<div class="container-fluid">
		...
		<li class="breadcrumbs__item">
            <li class="breadcrumbs__link breadcrumbs__link--active">HOMBRO</li>
        </li>
		</ol>
	</div>
			...
			<div class="row">
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
                        ...
                        <br>
                        <br>
                        <h5>PRESS DE HOMBROS CON MANCUERNAS </h5>
					</div>
				</div>
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
                        ...
                        <br>
                        <br>
                        <h5>LEVANTAMIENTOS FRONTALES DE MARTILLO </h5>
					</div>
				</div>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="icon-box-item">
                        ...
                        <br>
                        <br>
                        <h5>PLANCHA A PERRO BOCA ABAJO</h5>
					</div>
				</div>
	</section>
	<!-- Service section end -->
